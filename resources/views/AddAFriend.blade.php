													...
													<!--begin::User-->
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Details-->
																<div class="ms-4">
																	<a href="../../demo1/dist/apps/contacts/view-contact.html" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Emma Smith</a>
											...
											<div class="card card-flush h-lg-100" id="kt_contacts_main">
												...
												<div class="card-body p-0">
													...
													<div class="card-px text-center py-20 my-10">
														...
														<!--end::Description-->
														<!--begin::Action-->
														<a href="addfrind.html" class="btn btn-primary">Add New Friend</a>
														<!--end::Action-->
													</div>
													<!--end::Wrapper-->
													<!--begin::Illustration-->
