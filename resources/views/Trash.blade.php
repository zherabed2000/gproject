...
<body data-kt-name="metronic" id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="d-flex flex-column h-100">
                                                            ...
                                                            <div class="mb-7">
                                                                ...
                                                                <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                                    ...
                                                                    <div class="d-flex align-items-center me-5 me-xl-13">
                                                                        ...
                                                                        <!--begin::Info-->
                                                                        <div class="m-0">
                                                                            <a href="../../demo1/dist/apps/projects/users.html" class="fw-bold text-gray-800 text-hover-primary fs-7">{{$note->name}}</a>
                                                                            <span class="fw-semibold text-gray-400 d-block fs-8">{{$note->category->title ?? "---"}}</span>
                                                                        </div>
                                                                        <!--end::Info-->
                                                                    </div>
                                                                    <!--end::Item-->
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="m-0">
                                                                            ...
                                                                            <a href="#" class="fw-bold text-gray-800 text-hover-primary fs-7">{{$note->created_at}}</a>
                                                                        </div>
                                                                        <div class="m-5">
                                                                            <form style="display: inline-block;" method="POST" action="{{ URL('/note/recover/'.$note->id) }}">
                                                            ...
                                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                                ...
                                                                <a href="#" class="btn btn-light ">
                                                                    ...
                                                                    <!--end::Svg Icon-->
                                                                    {{-- current date - created at date --}}

                                                                    <span class="badge badge-light">{{$note->created_at->diffForHumans()}}</span>
                                                                </a>
  <a href="#" class="btn btn-light " data-bs-toggle="modal" data-bs-target="#kt_modal_users_search"><!--begin::Svg Icon | path: C:/wamp64/www/keenthemes/core/html/src/media/icons/duotune/coding/cod007.svg-->
                                                                ...
                                                                <form style="display: inline-block;" method="POST"
                                                                      action="{{ URL('/note/favourite/'.$note->id) }}">
