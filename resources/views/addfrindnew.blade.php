	...
	<div class="col-lg-6 col-xl-12 px-8 mb-5 mb-xl-10">
														...
														<div class="card card-flush" id="kt_contacts_list">
															...
															<div class="card-header pt-7" id="kt_contacts_list_header">
																...
																action="{{ route('addFrind') }}" method="get">
																	<!--begin::Icon-->
																...
																<div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true"
																	...
																	<div class="d-flex flex-stack py-4">
																		...
																		<div class="d-flex align-items-center">
																			...
																			<div class="ms-4">
																				<a href="#"
																					class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2"> {{ $user->name}} </a>
																				...
																				@else
																				<div class="badge badge-primary">  Status Not yet </div>
																				@endif
																			...
																			<td class="text-end">
																				...
																				<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
																					...
																					<div class="menu-item px-3">
																						<a href="{{ route('addFrindPost', $user->id )}}" class="menu-link px-3"><i class="fa-solid fa-user-plus"></i>Add</a>
																					</div>
																					<!--end::Menu item-->
																					<!--begin::Menu item-->
																					<div class="menu-item px-3">
																						<a href="{{ route('blokedFrind', $user->id )}}" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row"><i class="fa-solid fa-ban"></i>Block</a>
																					</div>
																					<!--end::Menu item-->
																				</div>
																				<!--end::Menu-->
