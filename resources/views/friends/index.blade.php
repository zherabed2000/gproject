                        ...
                        @foreach($friends as $friend)
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <a href="#"
                                           class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2"> {{ $friend->friend->name}} </a>
                                        <div class="fw-semibold fs-7 text-muted">  {{ $friend->friend->email}} </div>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            ...
                                            <a href="{{ route('friends.block', $friend->friend_id )}}"
                                               class="menu-link px-3"
                                               data-kt-ecommerce-category-filter="delete_row">
                                                <i class="fa-solid fa-ban" style="margin-right: 3px;"></i>
                                                {{ $friend->is_blocked ? "Unblock" : 'Block' }}
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body p-0">
                ...
                <div class="card-px text-center py-20 my-10">
                    ...
                    <!--end::Description-->
                    <!--begin::Action-->
                    <a href="{{ route('friends.add') }}" class="btn btn-primary">Add New Friend</a>
                    <!--end::Action-->
                </div>
                <!--end::Wrapper-->
                <!--begin::Illustration-->
