			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
								...
								<div id="kt_header_search" class="header-search d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end" data-kt-search="true">
									...
									<div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px" data-kt-menu="true">
										...
										<div data-kt-search-element="wrapper">
											...
											<form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
												...
												<div class="position-absolute top-50 end-0 translate-middle-y" data-kt-search-element="toolbar">
													...
													<div data-kt-search-element="preferences-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-1" data-bs-toggle="tooltip" data-kt-initialized="1">
													...
													<div data-kt-search-element="advanced-options-form-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary" data-bs-toggle="tooltip" data-kt-initialized="1">
										...
										<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
											...
											<!--begin::Input group-->
											<div class="mb-5">
												<select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="date_period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-1-lcfu" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
													<option value="next" data-select2-id="select2-data-3-dvkd">Within the next</option>
													<option value="last">Within the last</option>
													<option value="between">Between</option>
													<option value="on">On</option>
												</select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-2-piht" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-timezone-ln-container" aria-controls="select2-timezone-ln-container"><span class="select2-selection__rendered" id="select2-timezone-ln-container" role="textbox" aria-readonly="true" title="Within the next">Within the next</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
											<div class="row mb-8">
												...
												<!--begin::Col-->
												<div class="col-6">
													<select name="date_typer" aria-label="Select a Timezone" data-control="select2" data-placeholder="Period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-4-zoqi" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
														<option value="days" data-select2-id="select2-data-6-ankb">Days</option>
														<option value="weeks">Weeks</option>
														<option value="months">Months</option>
														<option value="years">Years</option>
													</select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-5-ef52" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-date_typer-e2-container" aria-controls="select2-date_typer-e2-container"><span class="select2-selection__rendered" id="select2-date_typer-e2-container" role="textbox" aria-readonly="true" title="Days">Days</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true" style="height: 541px;">
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<span class="menu-icon">
											...
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
													<path id="Vector" d="M0,20V6.667L10,0,20,6.667V20H12.5V12.222h-5V20Z" fill="#bfbfbf"></path>
												</svg>
								...
								<!--end:Menu item-->
								<!--begin:Menu item-->
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion hover showing">
									<!--begin:Menu link-->
									<a class="menu-link" href="categories.html">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="21.875" height="18.75" viewBox="0 0 21.875 18.75">
													<path id="Vector" d="M1.563,7.031h0ZM4.616.115a.781.781,0,0,1,.29.315l.563,1.133H8.594a.781.781,0,0,1,.781.781V7.813a.781.781,0,0,1-.781.781H.781A.781.781,0,0,1,0,7.813V.781A.781.781,0,0,1,.781,0H4.2a.781.781,0,0,1,.413.115ZM15.438,7.031h0ZM17.116.115a.781.781,0,0,1,.29.315l.563,1.133h3.125a.781.781,0,0,1,.781.781V7.813a.781.781,0,0,1-.781.781H13.281a.781.781,0,0,1-.781-.781V.781A.781.781,0,0,1,13.281,0H16.7a.781.781,0,0,1,.413.115ZM1.563,17.188h0Zm3.053-6.917a.781.781,0,0,1,.29.315l.563,1.133H8.594a.781.781,0,0,1,.781.781v5.469a.781.781,0,0,1-.781.781H.781A.781.781,0,0,1,0,17.969V10.938a.781.781,0,0,1,.781-.781H4.2a.781.781,0,0,1,.413.115Zm9.447,6.917h0Zm3.053-6.917a.781.781,0,0,1,.29.315l.563,1.133h3.125a.781.781,0,0,1,.781.781v5.469a.781.781,0,0,1-.781.781H13.281a.781.781,0,0,1-.781-.781V10.938a.781.781,0,0,1,.781-.781H16.7a.781.781,0,0,1,.413.115Z" transform="translate(0 0)" fill="#bfbfbf"></path>
												</svg>
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<!--begin:Menu link-->
									<a class="menu-link" href="AddAFriend.html">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
											<span class="svg-icon svg-icon-2">
												<svg id="fa-solid:user-friends" xmlns="http://www.w3.org/2000/svg" width="25" height="20" viewBox="0 0 25 20">
													<rect id="fa-solid:user-friends-2" data-name="fa-solid:user-friends" width="25" height="20" fill="none"></rect>
													<path id="Vector" d="M3.125,4.375A4.375,4.375,0,1,1,7.5,8.75,4.373,4.373,0,0,1,3.125,4.375ZM15,14.5v1.125A1.875,1.875,0,0,1,13.125,17.5H1.875A1.875,1.875,0,0,1,0,15.625V14.5A4.5,4.5,0,0,1,4.5,10h.324a6.04,6.04,0,0,0,5.352,0H10.5A4.5,4.5,0,0,1,15,14.5ZM15,5a3.75,3.75,0,1,1,3.75,3.75A3.751,3.751,0,0,1,15,5Zm10,9.375a1.875,1.875,0,0,1-1.875,1.875h-6.9c0-.082.023-.164.023-.25V14.5A5.717,5.717,0,0,0,14.7,10.6a4.339,4.339,0,0,1,2.176-.6h.148a4.926,4.926,0,0,0,3.453,0h.148A4.373,4.373,0,0,1,25,14.375Z" transform="translate(0 1.25)" fill="#bfbfbf"></path>
												</svg>
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<!--begin:Menu link-->
									<a class="menu-link" href="Trash.html">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="14.583" height="18.75" viewBox="0 0 14.583 18.75">
													<path id="Vector" d="M14.583,3.125H0V1.042H3.646L4.688,0H9.9l1.042,1.042h3.646M1.042,4.167h12.5v12.5a2.083,2.083,0,0,1-2.083,2.083H3.125a2.083,2.083,0,0,1-2.083-2.083Z" fill="#bfbfbf"></path>
												</svg>
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<a class="menu-link" href="faq.html">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
											<span class="svg-icon svg-icon-2">
												<svg id="mdi:frequently-asked-questions" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
													<rect id="mdi:frequently-asked-questions-2" data-name="mdi:frequently-asked-questions" width="24" height="24" fill="none"></rect>
													<path id="Vector" d="M16,13H4L0,17V1A1,1,0,0,1,1,0H16a1,1,0,0,1,1,1V12a1,1,0,0,1-1,1Zm5-6V21l-4-4H6a1,1,0,0,1-1-1V15H19V6h1a1,1,0,0,1,1,1ZM6.19,2a3.515,3.515,0,0,0-2.11.59,2.063,2.063,0,0,0-.77,1.77l.01.03H5.25a.915.915,0,0,1,.28-.69,1,1,0,0,1,.66-.23,1.035,1.035,0,0,1,.75.28,1.056,1.056,0,0,1,.26.75,1.387,1.387,0,0,1-.23.82,1.818,1.818,0,0,1-.61.59,4.039,4.039,0,0,0-1.05.91A1.975,1.975,0,0,0,5,8H7a1.693,1.693,0,0,1,.13-.74,1.39,1.39,0,0,1,.51-.52,3.143,3.143,0,0,0,1.11-.93A2.133,2.133,0,0,0,9.19,4.5a2.251,2.251,0,0,0-.81-1.82A3.279,3.279,0,0,0,6.19,2ZM5,9v2H7V9Zm6,2h2V9H11Zm0-9V8h2V2Z" transform="translate(2 2)" fill="#bfbfbf"></path>
												</svg>
					...
					<div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
						<a href="#" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" data-kt-initialized="1">
