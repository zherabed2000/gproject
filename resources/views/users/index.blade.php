        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <form action="{{ url()->current() }}">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" name="q" data-kt-ecommerce-category-filter="search" value="{{ request('q') }}"
                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            <div class="ms-5">
                                <!--begin::Title-->
                                <a href="{{ route('users.edit' , $user->id ) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                   data-kt-ecommerce-user-filter="user_name">{{$user->name}}</a>
                            </div>
                        </td>
                        <!--end::user=-->
                        <!--begin::Type=-->
