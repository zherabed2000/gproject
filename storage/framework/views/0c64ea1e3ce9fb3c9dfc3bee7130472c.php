...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="/">
            <img alt="Logo" src="<?php echo e(asset('assets/logonew.svg')); ?>"
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                ...
                <div class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="<?php echo e(route('notes.create')); ?>">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="<?php echo e(route('friends.index')); ?>">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                                            <span class="svg-icon svg-icon-2">
...
<!--end::sidebar-->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gproject/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>