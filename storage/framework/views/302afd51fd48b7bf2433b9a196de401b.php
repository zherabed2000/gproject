                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            ...
                                            <a href="<?php echo e(route('friends.block', $friend->id )); ?>"
                                               class="menu-link px-3"
                                               data-kt-ecommerce-category-filter="delete_row">
                                                <i class="fa-solid fa-ban" style="margin-right: 3px;"></i>
                                                <?php echo e($friend->is_blocked ? "Unblock" : 'Block'); ?>
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body p-0">
                ...
                <div class="card-px text-center py-20 my-10">
                    ...
                    <!--end::Description-->
                    <!--begin::Action-->
                    <a href="<?php echo e(route('friends.add')); ?>" class="btn btn-primary">Add New Friend</a>
                    <!--end::Action-->
                </div>
                <!--end::Wrapper-->
                <!--begin::Illustration-->
                <div class="text-center px-4">
                    <img class="mw-100 mh-300px" alt="" src="<?php echo e(asset('assets/media/illustrations/sketchy-1/5.png')); ?>">
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Card body-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gproject\resources\views/friends/index.blade.php ENDPATH**/ ?>