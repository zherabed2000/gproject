...
button#kt_sign_in_submit {
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					...
					<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
						...
						<div class="w-md-400px">
							<!--begin::Form-->
							<form class="form w-100"  action="<?php echo e(route('registerPost')); ?>" method="POST">
							<?php echo csrf_field(); ?>
								<!--begin::Heading-->
   ...
   <?php endif; ?>
								...
								<a href="<?php echo e(route('login')); ?>" class="link-primary fw-semibold">Sign in</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
	...
	<!--end::Body-->
</html><?php /**PATH /Users/moahemdabosido/Desktop/Projects/gproject/resources/views/sign-up.blade.php ENDPATH**/ ?>