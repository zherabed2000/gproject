...
button#kt_sign_in_submit {
				...
				<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
					...
					<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
						...
						<div class="w-md-400px">
							...
							method="post" action="<?php echo e(url('/main/checklogin')); ?>" >
   ...
   <?php endif; ?>
								...
								<div class="d-grid mb-10">
									<button name="login" type="submit" id="kt_sign_in_submit" class="btn btn-primary">
								...
								<a href="<?php echo e(route('register')); ?>" class="link-primary">Sign up</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
	...
	<!--end::Body-->
</html><?php /**PATH /Users/moahemdabosido/Desktop/Projects/gproject/resources/views/sign-in.blade.php ENDPATH**/ ?>