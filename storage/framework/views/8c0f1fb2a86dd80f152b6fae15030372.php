<?php $__env->startSection('content'); ?>
    ...
    <!--begin::Content-->
    <div class="col-lg-6 col-xl-12 px-8 mb-5 mb-xl-10">
        <!--begin::Contacts-->
        <div class="card card-flush" id="kt_contacts_list">
            ...
            <div class="card-header pt-7" id="kt_contacts_list_header">
                ...
                <form class="d-flex align-items-center position-relative w-100 m-0" autocomplete="off"
                    ...
                    <!--end::Icon-->
                    <!--begin::Input-->
                    <input type="text" class="form-control form-control-solid ps-13" name="search" value="<?php echo e(request('search')); ?>"
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="<?php echo e(route('friends.send', $user->id )); ?>" class="menu-link px-3"><i
                                                    class="fa-solid fa-user-plus"></i>Add</a>
                                        </div>
                                        <!--end::Menu item-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gproject\resources\views/friends/add.blade.php ENDPATH**/ ?>