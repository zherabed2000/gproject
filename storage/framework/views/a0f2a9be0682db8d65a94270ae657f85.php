                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="row">
                                <!--begin::Row-->
                                <div class="row px-8 mb-5 mb-xl-10">
                                    <!--begin::Col-->
                                                ...
                                                <div class="row gx-9 h-100">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="d-flex flex-column h-100">
                                                            ...
                                                            <div class="mb-7">
                                                                ...
                                                                <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                                    ...
                                                                    <div class="d-flex align-items-center me-5 me-xl-13">
                                                                        ...
                                                                        <!--begin::Info-->
                                                                        <div class="m-0">
                                                                            <a href="../../demo1/dist/apps/projects/users.html" class="fw-bold text-gray-800 text-hover-primary fs-7"><?php echo e($note->name); ?></a>
                                                                            <span class="fw-semibold text-gray-400 d-block fs-8"><?php echo e($note->category->title ?? "---"); ?></span>
                                                                        </div>
                                                                        <!--end::Info-->
                                                                    </div>
                                                                    <!--end::Item-->
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="m-0">
                                                                            ...
                                                                            <a href="#" class="fw-bold text-gray-800 text-hover-primary fs-7"><?php echo e($note->created_at); ?></a>
                                                                        </div>
                                                                        <div class="m-5">
                                                                            <form style="display: inline-block;" method="POST" action="<?php echo e(URL('/note/recover/'.$note->id)); ?>">
                                                                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                                                <button class="btn btn-light fw-bold text-gray-800 text-hover-primary fs-7" type="submit">
                                                            ...
                                                            <!--end::Header-->
                                                            <!--begin::Body-->
                                                            <div class="d-flex flex-column  text-left pt-5 pb-7 mb-8 card-rounded">
                                                            ...
                                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                                ...
                                                                <a href="#" class="btn btn-light ">
                                                                    ...
                                                                    <span class="badge badge-light"><?php echo e($note->created_at->diffForHumans()); ?></span>
                                                                </a>
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        ...
                        <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Note sharing system</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
...
<?php /**PATH /Users/moahemdabosido/Desktop/Projects/gproject/resources/views/Trash.blade.php ENDPATH**/ ?>