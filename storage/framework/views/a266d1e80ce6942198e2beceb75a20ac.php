                ...
                <div class="col-sm-12">
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex justify-content-between  flex-stack mt-auto bd-highlight">
                            ...
                            <?php else: ?>
                                <a class="btn btn-light mr-2 text-center delete"
                                   data-url="<?php echo e(route('notes.share.destroy' , $note->id )); ?>"
                                   href="javascript:;">
                                <span class="svg-icon svg-icon-2 mr-0"><svg
                                        width="24" height="24"
                                        viewBox="0 0 24 24" fill="none"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gproject/resources/views/notes/card.blade.php ENDPATH**/ ?>