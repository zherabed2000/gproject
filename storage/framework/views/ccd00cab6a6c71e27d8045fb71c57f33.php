    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="/" class="d-lg-none">
                <img alt="Logo" src="<?php echo e(asset('assets/logonew.svg')); ?>" class="h-30px"/>
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                             style="background-image:url('<?php echo e(asset('assets/media/misc/pattern-1.jpg')); ?>')">
                            <!--begin::Title-->
                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Notifications
                                <span class="fs-8 opacity-75 ps-3"><?php echo e($notifications->count()); ?></span>
                            </h3>
                            <!--end::Title-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="scroll-y mh-325px my-5 px-8">
                                <?php echo $__env->make('notifications.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--begin::Menu toggle-->
                    <a href="<?php echo e(route('friends.new')); ?>"
                       class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <a href="<?php echo e(url('/main/logout')); ?>"
...
<!--end::Header-->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gproject/resources/views/layouts/header.blade.php ENDPATH**/ ?>