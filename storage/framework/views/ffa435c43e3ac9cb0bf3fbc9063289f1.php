                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
                        <a href="#"
                            ...
                            <span class="btn-label">Website Home</span>
                            ...
                            <div
                                ...
                                <div class="text-dark order-2 order-md-1">
                                    ...
                                    <a href="https://keenthemes.com" target="_blank"
                                        class="text-gray-800 text-hover-primary">Note
                                        sharing system</a>
                                </div>
                                <!--end::Copyright-->
                                <!--begin::Menu-->
                                            ...
                                            <div class="row g-9 mb-8">
                                                ...
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <select class="form-select form-select-solid"
                                                        ...
                                                        <option value="2" selected="selected">Robert Doe
                                                        </option>
                                            ...
                                            <div class="d-flex fv-row">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="text-gray-600">Increase impression traffic onto
                                                            the
                                                            platform
                                                        </div>
                                                    </label>
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <div class="dropzone" id="kt_modal_create_campaign_files_upload">
                                                ...
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="ms-4">
                                                        <h3 class="dfs-3 fw-bold text-gray-900 mb-1">Drop campaign
                                                            files
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <div class="d-flex flex-column text-center">
                                                ...
                                                <div id="kt_modal_create_campaign_budget_slider" class="noUi-sm">
                                                </div>
                                            </div>
                                            <!--end::Slider-->
                                        </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-12 text-center">
                                            ...
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="fw-semibold text-muted fs-4">You will receive an email with
                                                with the
                                        ...
                                        <div class="d-flex flex-center pb-20">
                                            ...
                                            <a href="" class="btn btn-lg btn-primary"
                                                data-bs-toggle="tooltip" title="Coming Soon">View Campaign</a>
                                        </div>
                                        <!--end::Actions-->
                                        <!--begin::Illustration-->
                                        <div class="text-center px-4">
...
<?php /**PATH /Users/moahemdabosido/Desktop/Projects/gproject/resources/views/layouts/master.blade.php ENDPATH**/ ?>